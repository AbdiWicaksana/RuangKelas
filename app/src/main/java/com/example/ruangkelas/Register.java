...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_register = (Button) findViewById(R.id.RegistButton);
        txt_username = (EditText) findViewById(R.id.RegistUser);
        txt_email = (EditText) findViewById(R.id.RegistEmail);
        txt_password = (EditText) findViewById(R.id.RegistPass);
        txt_confirm_password = (EditText) findViewById(R.id.RegistConfPass);
